...
### Authentication error in Copilot

![Error](./images/99-Copilot-authentication-error.png)

This generally goes away after the first try. Enter "New chat" and try again.
